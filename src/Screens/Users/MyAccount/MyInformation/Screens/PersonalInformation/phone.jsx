  ...
  return (
    <MyInformationEdit label='Phone'>
      ...
      <form onSubmit={handleSubmit}>
        <Box>
          <InputsBox columns={1}>
            <InputBasic id='phone' name='store.customer.phone' label='Phone' value={editedData.store.customer.phone} onInput={handleInputChange} fullWidth />
          </InputsBox>
        </Box>
        <Buttons />
      </form>
