...
export default function AddressLine2 () {
  ...
  return (
    <MyInformationEdit label='Address Line 2'>
      ...
      <form onSubmit={handleSubmit}>
        <Box>
          <InputsBox columns={1}>
            <InputBasic id='AddressLine1' name='store.customer.billing_address2' label='Address Line 2' value={editedData.store.customer.billing_address2} onInput={handleInputChange} fullWidth />
          </InputsBox>
        </Box>
        <Buttons />
      </form>
