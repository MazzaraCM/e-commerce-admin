...
export function TabRefunds(){
  return(
    <>
        <Grid container spacing={1} direction={'row'} justifyContent={'center'}>
            <Grid item xs={12} sm={6} md={3}>
                <SimpleDataCard icon={<StorageOutlinedIcon />} title='Data Base' description='2' />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
                <SimpleDataCard icon={<StorefrontOutlinedIcon />} title='Shopify' description='2' />
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <Tabs value={value} onChange={handleChange} variant="scrollable" centered>
        <Tab label="All Refunds" {...a11yProps(0)} />
        <Tab label="Missing Records" {...a11yProps(1)} />
        <Tab label="Missing Transactions" {...a11yProps(2)} />
        <Tab label="Repeat Transactions" {...a11yProps(3)} />
      </Tabs>
      </Box>
