...
const FormMenuOptions = ({ apiRequestState, onSuccess, settingsData }) => {
  ...
  return (
    <Box component='form' onSubmit={handleSubmit}>
      <InputsBox columns={2}>
        <InputBasic label='Name' name='menu-name' type='text' sublabel='El nombre que tendrá el role' fullWidth required />
        <InputBasic label='URL' name='menu-url' type='text' sublabel='El nivel de seguridad máximo que tendrá el role' fullWidth required />
        <InputBasic label='Icon' name='menu-icon' type='text' sublabel='El nivel de seguridad máximo que tendrá el role' fullWidth required />
        <InputBasic label='Color' name='menu-color' type='text' sublabel='El dashboard que se le asignará al role' fullWidth required />
      </InputsBox>
...
export default function MenuOptionsRegister () {
            ...
            ComponentWatcherSuccess: (
              <>
                <BoxShadow sx={{ marginBottom: 2 }}>
                  <BoxShadowHeader title='Menu Option Data' subtitle='Crea un lenguaje o selecciona uno para ver su información' />
                  <FormMenuOptions settingsData={settingsList} apiRequestState={apiRequestState} onSuccess={handleGetSettings} />
                </BoxShadow>
                <BoxShadow>
                  <DialogProvider>
                    <Dialogs />
                    <DataGridTable
                      ...
                      subtitle='Tabla de Opciones del menú'
