...
const FormRoles = ({ apiRequestState, onSuccess, settingsData }) => {
  ...
  return (
    <Box component='form' onSubmit={handleSubmit}>
      <InputsBox columns={3}>
        <InputBasic label='Name' name='role-name' type='text' sublabel='El nombre que tendrá el role' fullWidth required />
        <InputBasic label='Security Level' name='role-security-level' type='text' sublabel='El nivel de seguridad máximo que tendrá el role' fullWidth required />
        <InputBasic label='Dashboard Page' name='role-dashboard-page' type='text' sublabel='El dashboard que se le asignará al role' fullWidth required />
      </InputsBox>
...
export default function RolesRegister () {
            ...
            ComponentWatcherSuccess: (
              <>
                <BoxShadow sx={{ marginBottom: 2 }}>
                  ...
                  <FormRoles settingsData={settingsList} apiRequestState={apiRequestState} onSuccess={handleGetSettings} />
                </BoxShadow>
                <BoxShadow>
                  <DialogProvider>
                    <Dialogs />
